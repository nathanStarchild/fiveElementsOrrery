...
CRGBPalette16 cyclePalettes[nPalettes] = {
  ...
  OceanColors_p,//pink green whiteish purple
  Deep_Skyblues_gp,//blue and brown
  CloudColors_p, //2
  Id_Like_To_Dive_gp,//white pastels
  Deep_Skyblues_gp,//bold blue purple yellow red NOPE
  ...
  Deep_Skyblues_gp, //7
  Alive_And_Kicking_gp,   
  OceanColors_p,//green brown white
};
